...
/**
 The base class for all Client_Programs_App modules
 */
...
/**
 Client_Programs_App Platform calls this method on startup.
 */
- (void)startup;

/**
 Client_Programs_App Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
- (void)shutdown:(id)sender;

/**
 Client_Programs_App Platform calls this method on suspend.
 @param sender The sender of the event.
 */
- (void)suspend:(id)sender;

/**
 Client_Programs_App Platform calls this method on entering background.
 @param sender The sender of the event.
 */
- (void)paused:(id)sender;

/**
 Client_Programs_App Platform calls this method on resume.
 @param sender The sender of the event.
 */
