...
//@interface Client_Programs_AppObject : NSObject
//@end

@interface Client_Programs_AppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[Client_Programs_AppObject class]]) {
      for (NSString *key in [[(Client_Programs_AppObject *)o modules] allKeys]) {
