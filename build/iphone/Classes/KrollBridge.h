...
@interface Client_Programs_AppObject : KrollCoverageObject {
#else
@interface Client_Programs_AppObject : KrollObject {
#endif
  @private
...
extern NSString *Client_Programs_App$ModuleRequireFormat;
...
@interface KrollBridge : Bridge <TiEvaluator, KrollDelegate> {
  ...
  Client_Programs_AppObject *_client_programs_app;
  KrollObject *console;
  BOOL shutdown;
