...
//Rare exceptions to indicate a bug in the _client_programs_app code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Client_Programs_App proxies.
 */
