...
/**
 Base class for all Client_Programs_App views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Client_Programs_App view hierarchy (such as wrapped iOS UIViews) was touched.
