...
function Controller() {
    ...
    function drawTable() {
        ...
        var arr = [];
        for (y in string[events]) arr.push(Alloy.createController("card-row", {
            file: file,
    ...
    function addNewCard() {
        var addwin = Alloy.createController("card-addcard", {
            file: file,
            events: events
        }).getView();
        addwin.open();
    ...
    function sendAllEmail() {
        ...
        for (x in string[events]) {
            ...
            str += '<Row><Cell ss:StyleID="s75"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String">' + events + '</Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String">' + string[events][x].oid + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + firstName + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + lastName + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][x].add1 + ",\n" + string[events][x].add2 + ",\n" + string[events][x].add3 + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][x].city + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][x].state + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="Number">' + string[events][x].postcode + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][x].phone + '</Data></Cell><Cell ss:StyleID="s66"/><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][x].mobile + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s86" ss:HRef="' + string[events][x].email + '"><Data ss:Type="String">' + string[events][x].email + '</Data></Cell><Cell ss:StyleID="s66"/><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"/><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s67"/><Cell ss:StyleID="s67"><Data ss:Type="Number"></Data></Cell><Cell ss:StyleID="s66"/><Cell ss:StyleID="s83"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s80"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String">' + string[events][x].guestof + '</Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String">' + string[events][x].reltoclient + '</Data></Cell><Cell ss:StyleID="s64"/><Cell ss:StyleID="s68"/><Cell ss:StyleID="s64"/><Cell ss:StyleID="s65"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String"></Data></Cell></Row>';
        }
        ...
        emailDialog.addEventListener("complete", function(e) {
            if (e.result == emailDialog.SENT) {
                for (x in string[events]) string[events][x].sent = "true";
    ...
    this.__controllerPath = "card-event";
    if (arguments[0]) {
        {
    ...
    addNewCard ? $.__views.add.addEventListener("click", addNewCard) : __defers["$.__views.add!click!addNewCard"] = true;
    ...
    $.__views.win2.add($.__views.bottombar);
    $.__views.send = Ti.UI.createButton({
        ...
        id: "send",
        title: "   Send All Cards in Event   "
    });
    $.__views.bottombar.add($.__views.send);
    sendAllEmail ? $.__views.send.addEventListener("click", sendAllEmail) : __defers["$.__views.send!click!sendAllEmail"] = true;
    ...
    __defers["$.__views.add!click!addNewCard"] && $.__views.add.addEventListener("click", addNewCard);
    ...
    __defers["$.__views.send!click!sendAllEmail"] && $.__views.send.addEventListener("click", sendAllEmail);
    _.extend($, exports);
}
