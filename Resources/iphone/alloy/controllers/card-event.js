...
function Controller() {
  ...
  { backgroundColor: "#163318", id: "win2", title: "Cards" });
  ...
  { height: Ti.UI.SIZE, color: "#fff", bottom: "10dp", font: { fontSize: 20 }, text: 'Cards', id: "topTitle" });

  $.__views.topbar.add($.__views.topTitle);
  $.__views.add = Ti.UI.createButton(
  { height: Ti.UI.SIZE, color: "#fff", bottom: "10dp", right: "50dp", borderColor: "#fff", borderRadius: "10dp", backgroundColor: "#274429", font: { fontSize: 14 }, id: "add", title: "   Add Card   " });

  $.__views.topbar.add($.__views.add);
  addNewCard ? $.addListener($.__views.add, 'click', addNewCard) : __defers['$.__views.add!click!addNewCard'] = true;$.__views.back = Ti.UI.createButton(
  ...
  closeWindow ? $.addListener($.__views.back, 'click', closeWindow) : __defers['$.__views.back!click!closeWindow'] = true;var __alloyId7 = [];$.__views.__alloyId8 = Ti.UI.createTableViewRow(
  { backgroundColor: "transparent", height: "80dp", id: "__alloyId8" });

  __alloyId7.push($.__views.__alloyId8);$.__views.table = Ti.UI.createTableView(
  { backgroundColor: "transparent", top: "60dp", data: __alloyId7, id: "table", backgroundImage: "/Fisher-3.png", editable: true, rowHeight: 80 });

  $.__views.win2.add($.__views.table);
  rowClick ? $.addListener($.__views.table, 'click', rowClick) : __defers['$.__views.table!click!rowClick'] = true;$.__views.bottombar = Ti.UI.createView(
  { bottom: "-10dp", height: "70dp", width: "103%", borderColor: "#fff", borderRadius: "30dp", borderWidth: "2dp", backgroundColor: "#215525", id: "bottombar" });

  $.__views.win2.add($.__views.bottombar);
  $.__views.send = Ti.UI.createButton(
  { height: Ti.UI.SIZE, color: "#fff", borderColor: "#fff", borderRadius: "10dp", backgroundColor: "#274429", font: { fontSize: 16 }, id: "send", title: "   Send All Cards in Event   " });

  $.__views.bottombar.add($.__views.send);
  sendAllEmail ? $.addListener($.__views.send, 'click', sendAllEmail) : __defers['$.__views.send!click!sendAllEmail'] = true;exports.destroy = function () {};
