...
function Controller() {
    ...
    function setStyle() {
        ...
        "true" == $.sent.sent && ($.sent.text = "Email Sent");
    }
    function editMe() {
        if ("false" == edit) {
            edit = "true";
    ...
    function sendEmail() {
        ...
        if ("true" == edit) {
            ...
            file.write(JSON.stringify(string)) || calert("Error", "Failed to update file");
            editMe();
            return;
        }
        ...
        str += '<Row><Cell ss:StyleID="s75"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String">' + events + '</Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String">' + string[events][index].oid + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + firstName + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + lastName + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][index].add1 + ",\n" + string[events][index].add2 + ",\n" + string[events][index].add3 + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][index].city + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][index].state + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="Number">' + string[events][index].postcode + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][index].phone + '</Data></Cell><Cell ss:StyleID="s66"/><Cell ss:StyleID="s66"><Data ss:Type="String">' + string[events][index].mobile + '</Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s86" ss:HRef="' + string[events][index].email + '"><Data ss:Type="String">' + string[events][index].email + '</Data></Cell><Cell ss:StyleID="s66"/><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"/><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s66"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s67"/><Cell ss:StyleID="s67"><Data ss:Type="Number"></Data></Cell><Cell ss:StyleID="s66"/><Cell ss:StyleID="s83"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s80"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String">' + string[events][index].guestof + '</Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String">' + string[events][index].reltoclient + '</Data></Cell><Cell ss:StyleID="s64"/><Cell ss:StyleID="s68"/><Cell ss:StyleID="s64"/><Cell ss:StyleID="s65"><Data ss:Type="String"></Data></Cell><Cell ss:StyleID="s65"><Data ss:Type="String"></Data></Cell></Row>';
        ...
        fileOut.write(str) || calert("Error", "Failed to export xml file");
        emailDialog.subject = "Info Card for " + $.name.value + " from " + events;
        emailDialog.toRecipients = [ "CSJuniorAssociates@fi.com" ];
        ...
        emailDialog.addEventListener("complete", function(e) {
            if (e.result == emailDialog.SENT) {
                ...
                var cprompt = Alloy.createController("card-prompt", {
                    events: events,
                    index: index,
                    all: false
                }).getView();
                cprompt.open();
                fileOut.deleteFile();
            } else calert("Error", "Email not sent");
        });
    }
    function calert(t, m) {
    ...
    refresh ? $.__views.win3.addEventListener("focus", refresh) : __defers["$.__views.win3!focus!refresh"] = true;
    ...
    focusNext ? $.__views.name.addEventListener("return", focusNext) : __defers["$.__views.name!return!focusNext"] = true;
    $.__views.viewFields = Ti.UI.createView({
        height: "60dp",
        layout: "horizontal",
        apiName: "Ti.UI.View",
    ...
    focusNext ? $.__views.add1.addEventListener("return", focusNext) : __defers["$.__views.add1!return!focusNext"] = true;
    $.__views.viewFields = Ti.UI.createView({
        height: "60dp",
        layout: "horizontal",
        apiName: "Ti.UI.View",
    ...
    focusNext ? $.__views.add2.addEventListener("return", focusNext) : __defers["$.__views.add2!return!focusNext"] = true;
    $.__views.viewFields = Ti.UI.createView({
        height: "60dp",
        layout: "horizontal",
        apiName: "Ti.UI.View",
    ...
    focusNext ? $.__views.add3.addEventListener("return", focusNext) : __defers["$.__views.add3!return!focusNext"] = true;
    $.__views.viewFields = Ti.UI.createView({
        height: "60dp",
        layout: "horizontal",
        apiName: "Ti.UI.View",
    ...
    focusNext ? $.__views.city.addEventListener("return", focusNext) : __defers["$.__views.city!return!focusNext"] = true;
    ...
    focusNext ? $.__views.state.addEventListener("return", focusNext) : __defers["$.__views.state!return!focusNext"] = true;
    $.__views.postcodelbl = Ti.UI.createLabel({
        width: Ti.UI.SIZE,
        height: Ti.UI.SIZE,
        color: "#fff",
        bottom: "10dp",
    ...
    focusNext ? $.__views.postcode.addEventListener("return", focusNext) : __defers["$.__views.postcode!return!focusNext"] = true;
    ...
    focusNext ? $.__views.phone.addEventListener("return", focusNext) : __defers["$.__views.phone!return!focusNext"] = true;
    $.__views.mobilelbl = Ti.UI.createLabel({
        width: Ti.UI.SIZE,
        height: Ti.UI.SIZE,
        color: "#fff",
        bottom: "10dp",
    ...
    focusNext ? $.__views.mobile.addEventListener("return", focusNext) : __defers["$.__views.mobile!return!focusNext"] = true;
    $.__views.viewFields = Ti.UI.createView({
        height: "60dp",
        layout: "horizontal",
        apiName: "Ti.UI.View",
    ...
    focusNext ? $.__views.email.addEventListener("return", focusNext) : __defers["$.__views.email!return!focusNext"] = true;
    $.__views.separator = Ti.UI.createView({
        width: "90%",
        height: "1dp",
        backgroundColor: "#5C705D",
    ...
    focusNext ? $.__views.guestof.addEventListener("return", focusNext) : __defers["$.__views.guestof!return!focusNext"] = true;
    $.__views.oidlbl = Ti.UI.createLabel({
        width: Ti.UI.SIZE,
        height: Ti.UI.SIZE,
        color: "#fff",
        bottom: "10dp",
    ...
    focusNext ? $.__views.oid.addEventListener("return", focusNext) : __defers["$.__views.oid!return!focusNext"] = true;
    $.__views.viewFields = Ti.UI.createView({
        height: "60dp",
        layout: "horizontal",
        apiName: "Ti.UI.View",
    ...
    sendEmail ? $.__views.informBtn.addEventListener("click", sendEmail) : __defers["$.__views.informBtn!click!sendEmail"] = true;
    $.__views.sent = Ti.UI.createLabel({
        width: Ti.UI.SIZE,
        height: Ti.UI.SIZE,
        color: "#aaa",
        bottom: "10dp",
    ...
    __defers["$.__views.win3!focus!refresh"] && $.__views.win3.addEventListener("focus", refresh);
    ...
    __defers["$.__views.name!return!focusNext"] && $.__views.name.addEventListener("return", focusNext);
    __defers["$.__views.add1!return!focusNext"] && $.__views.add1.addEventListener("return", focusNext);
    __defers["$.__views.add2!return!focusNext"] && $.__views.add2.addEventListener("return", focusNext);
    __defers["$.__views.add3!return!focusNext"] && $.__views.add3.addEventListener("return", focusNext);
    __defers["$.__views.city!return!focusNext"] && $.__views.city.addEventListener("return", focusNext);
    __defers["$.__views.state!return!focusNext"] && $.__views.state.addEventListener("return", focusNext);
    __defers["$.__views.postcode!return!focusNext"] && $.__views.postcode.addEventListener("return", focusNext);
    __defers["$.__views.phone!return!focusNext"] && $.__views.phone.addEventListener("return", focusNext);
    __defers["$.__views.mobile!return!focusNext"] && $.__views.mobile.addEventListener("return", focusNext);
    __defers["$.__views.email!return!focusNext"] && $.__views.email.addEventListener("return", focusNext);
    __defers["$.__views.guestof!return!focusNext"] && $.__views.guestof.addEventListener("return", focusNext);
    __defers["$.__views.oid!return!focusNext"] && $.__views.oid.addEventListener("return", focusNext);
    __defers["$.__views.informBtn!click!sendEmail"] && $.__views.informBtn.addEventListener("click", sendEmail);
    _.extend($, exports);
}
