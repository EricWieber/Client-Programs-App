...
function Controller() {
  ...
  { backgroundColor: "#163318", id: "win2", title: "Events" });
  ...
  closeWindow ? $.addListener($.__views.back, 'click', closeWindow) : __defers['$.__views.back!click!closeWindow'] = true;var __alloyId9 = [];$.__views.__alloyId10 = Ti.UI.createTableViewRow(
  { backgroundColor: "transparent", height: "80dp", id: "__alloyId10" });

  __alloyId9.push($.__views.__alloyId10);$.__views.table = Ti.UI.createTableView(
  { backgroundColor: "transparent", top: "60dp", data: __alloyId9, id: "table", backgroundImage: "/Fisher-3.png", editable: true, rowHeight: 80 });
  ...
  if (!file.exists()) {
    var string = {
      'Big Event': [{ 'name': 'Mr. Sample', 'add1': '123 Some St', 'add2': 'Line 2', 'add3': 'Line 3', 'city': 'Someville', 'state': 'CA', 'postcode': '91234',
        ...
        'guestof': 'Ken', 'reltoclient': 'friend', 'oid': '1234567890', 'sent': 'false' }, { 'name': 'Tom', 'add1': '123 Some St', 'add2': '', 'add3': '', 'city': 'Someville', 'state': 'CA', 'postcode': '91234',
