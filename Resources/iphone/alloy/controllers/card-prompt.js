...
function Controller() {
    ...
    function removeCard() {
        $.win.close();
        all ? Ti.App.fireEvent("removeEvent", {
            events: events
    ...
    $.__views.__alloyId12 = Ti.UI.createScrollView(function() {
        var o = {};
    ...
    $.__views.prompt = Ti.UI.createLabel({
        ...
        color: "#fff",
        textAlign: Ti.UI.TEXT_ALIGNMENT_CENTER,
        text: "Do you want to remove the Card(s)?",
        id: "prompt"
    });
    ...
    removeCard ? $.__views.yes.addEventListener("click", removeCard) : __defers["$.__views.yes!click!removeCard"] = true;
    ...
    closeWindow ? $.__views.no.addEventListener("click", closeWindow) : __defers["$.__views.no!click!closeWindow"] = true;
    ...
    __defers["$.__views.yes!click!removeCard"] && $.__views.yes.addEventListener("click", removeCard);
    __defers["$.__views.no!click!closeWindow"] && $.__views.no.addEventListener("click", closeWindow);
    _.extend($, exports);
}
